...
function showPhoto(name, firstcoord) {
    switch (name) {
        case "丽泽湖":
            $('#buildingImg').attr("src", "card/images/wildboar.jpg")
            break;
        case "体育馆":
            $('#buildingImg').attr("src", "card/images/gym.jpg")
            break;

        case "元白楼":
            $('#buildingImg').attr("src", "card/images/yuanbai.jpg")
            break;

        case "游泳池":
            $('#buildingImg').attr("src", "card/images/swimmingpool.jpg")
            break;

        case "文华苑":
            $('#buildingImg').attr("src", "card/images/wenhua.jpg")
            break;

        case "木铎楼":
            $('#buildingImg').attr("src", "card/images/muduo.gif")
            break;

        case "励耘楼":
            $('#buildingImg').attr("src", "card/images/liyun.jpg")
            break;

        case "京华苑":
            $('#buildingImg').attr("src", "card/images/jinghua.jpg")
            break;

        case "图书馆":
            $('#buildingImg').attr("src", "card/images/library.jpg")
            break;
        case "海华苑":
            // console.log(firstcoord)
            if (firstcoord == 476) {
                $('#buildingImg').attr("src", "card/images/haihua.jpg")
            } else {
                $('#buildingImg').attr("src", "card/images/haihua2.jpg")
            }
            break;

        case "弘文楼":
            $('#buildingImg').attr("src", "card/images/hongwen.jpg")
            break;

        case "金声楼":
            $('#buildingImg').attr("src", "card/images/jinsheng.jpg")
            break;

        case "丽泽楼":
            $('#buildingImg').attr("src", "card/images/lize.jpg")
            break;

        case "学一食堂":
            $('#buildingImg').attr("src", "card/images/xueyi.jpg")
            break;

        case "学二食堂":
            $('#buildingImg').attr("src", "card/images/xueer.jpg")
            break;

        case "学三食堂":
            $('#buildingImg').attr("src", "card/images/xuesan.jpg")
            break;

        case "田径场":
            $('#buildingImg').attr("src", "card/images/tianjingchang.jpg")
            break;

        case "燕华苑":
            $('#buildingImg').attr("src", "card/images/yanhua.jpg")
            break;

        case "会同街":
            $('#buildingImg').attr("src", "card/images/huitong.gif")
            break;

        case "励教楼":
            $('#buildingImg').attr("src", "card/images/lijiao.jpg")
            break;

        case "南曦园":
            $('#buildingImg').attr("src", "card/images/nanxi.jpg")
            break;

        case "京师家园":
            $('#buildingImg').attr("src", "card/images/jingshi.jpg")
            break;

        case "乐育楼":
            $('#buildingImg').attr("src", "card/images/leyu.jpg")
            break;

        case "粤华苑":
            $('#buildingImg').attr("src", "card/images/yuehua.jpg")
            break;

        case "国交足球场":
            $('#buildingImg').attr("src", "card/images/guojiaozuqiuchang.jpg")
            break;
    }
}
